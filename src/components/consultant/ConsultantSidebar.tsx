...
export function ConsultantSidebar() {
  return (
    <div className="hidden md:flex w-64 flex-col border-r bg-bibabop-navy text-white">
      <div className="p-6">
      ...
      <nav className="flex-1 px-4 space-y-2">
        <Link to="/consultant/dashboard">
          <Button variant="ghost" className="w-full justify-start text-white hover:bg-bibabop-navy hover:bg-opacity-80">
      ...
      <div className="p-4 mt-auto border-t border-bibabop-navy border-opacity-30 space-y-2">
