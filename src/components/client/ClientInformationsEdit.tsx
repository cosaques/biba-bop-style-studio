...
interface ClientInformationsEditProps {
  onClose: () => void;
}

export const ClientInformationsEdit = ({ onClose }: ClientInformationsEditProps) => {
  ...
  return (
    <Card className="w-full max-w-md mx-auto">
      <CardHeader>
        ...
        <CardDescription>
          Mettez à jour vos informations morphologiques
        </CardDescription>
      </CardHeader>
